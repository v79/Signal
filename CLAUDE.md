...
**Signal track:** Separate from research fields but fed by Physics and Mathematics investment plus signal analysis infrastructure (Deep Space Arrays, dedicated projects). Three decoding stages across eras. Wormhole climax is a late-game choice card with 2–3 candidate responses; quality of preparation determines how many options appear and how clearly consequences are signalled.
...
- Discussion and ideas go in planning/DESIGN_<featureName>.md
