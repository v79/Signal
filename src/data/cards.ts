...
export const CARD_DEFS: Map<string, CardDef> = new Map([
  ...
  [
    'voxPopuli',
    {
      ...
      description: 'A series of public polls to survey public opinion.',
      flavourText: 'The people’s voice is a powerful force in politics.',
      era: 'earth',
      effect: { fields: { socialScience: 10 }, resources: { funding: -2 } },
      counterEffect: {
  ...
  [
    'jungleExpedition',
    {
      ...
      description: 'Send a team to remote locations to explore exotic flora and fauna',
      flavourText: 'There is still so much life on Earth to be discovered.',
      era: 'earth',
      effect: { fields: { biology: 10, chemistry: 8 }, resources: { funding: -2 } },
      counterEffect: null,
      upgradesFrom: null,
    },
  ],
