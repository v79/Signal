...
// Body strings support rich-text markup: **bold**, *italic*, __underline__,
// {facility:id}, {technology:id}
// =============================================================================
...
export const HELP_TOPICS: Record<HelpTopicId, HelpTopic> = {
  earth: {
    title: 'Earth Map',
    body: [
      "**YOUR GOAL** Build a {facility:spaceLaunchCentre} to reach orbit — you'll need the {technology:orbitalMechanics} technology first. Once it's complete, the Near Space tab will open.",
      ...
      'Adjacency matters. Some facilities boost or penalise their neighbours — for example, a {facility:researchLab} next to a {facility:publicUniversity} strengthens both. Hover the tile glyphs to see which adjacencies apply.',
  ...
  space: {
    ...
    body: [
      '**YOUR GOAL** Build a {facility:signalRelayStation} to continue progressing the Signal, then complete the Orbital Station landmark to establish a permanent presence in space. Once finished, begin the Moon Colony programme — that unlocks the Asteroid Belt in Era 3.',
      ...
      "Building anything in Near Space requires a working {facility:spaceLaunchCentre} on Earth (and other capacity sources, like {facility:fuelDepot} and {facility:lunarLaunchFacility} facilities). The LAUNCH CAPACITY widget at the top of this tab shows how many supply units you've got and how many are committed.",
  ...
  belt: {
    title: 'Asteroid Belt',
    body: [
      '**YOUR GOAL** Establish transit to the heliopause node and decode the alien signal. The {technology:signalPatternAnalysis} technology is essential for the final decoding stages.',
  ...
  projects: {
    title: 'Projects',
    body: [
      '**YOUR GOAL** Initiate the next landmark project to advance to the next era. Landmarks are the primary progression gates — everything else is in service of reaching them.',
  ...
  board: {
    ...
    body: [
      '**YOUR GOAL** Keep every role filled — empty slots leave cards greyed out and weaken your programme. When a seat opens, recruit the best available candidate before the grace period ends.',
  ...
  blocs: {
    title: 'Blocs',
    body: [
      '**YOUR GOAL** Track rival blocs to anticipate diplomatic events and competitive pressure. If a bloc is racing toward the wormhole, expect competitive events — prepare accordingly.',
  ...
  techTree: {
    ...
    body: [
      '**YOUR GOAL** Build the facilities that feed the research fields each tech recipe needs — research happens automatically. You never spend points directly; you invest in infrastructure that produces them.',
