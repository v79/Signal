...
export const FACILITY_DEFS: Map<string, FacilityDef> = new Map([
  ...
  ['hq', {
    id: 'hq',
    name: 'Headquarters',
    description: 'The organisational centre of your programme. Provides a steady trickle of resources each turn. Cannot be demolished.',
    era: 'earth',
    ...
    deleteTime: 0,
    canDelete: false,
    fieldOutput: { physics: 1, mathematics: 1, engineering: 1, computing: 1, socialScience: 1, biochemistry: 1 },
    resourceOutput: {},
    adjacencyBonuses: [],
    adjacencyPenalties: [],
    depletes: false,
  ...
  ['offshoreWindFarm', {
    ...
    description: 'Generates steady Funding and minor Engineering field points. Requires coastal tile.',
    era: 'earth',
